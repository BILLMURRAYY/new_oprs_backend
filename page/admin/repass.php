        ...
        <div class="content-wrapper" style="min-height: 608px;">
            <div class="contain">
                <div class="card card-primary">
                    ...
                    ?>
                        <form action="back_repass.php" id="" method="post" onSubmit="return chkpsw(this)" enctype="multipart/form-data">
                            <div class="card-body">

                                <div class="form-group">
                                    <input type="hidden" name="member_id" value="<?php echo $id_member ?>">
                                    <label>แผนก</label>
                                    <select id="m_position" name="id_depart" class="select2" style="width: 100%;" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2" data-select2-id="83">
                                            <div class="form-group" data-select2-id="82">
                                                ...
                                                <select id="m_prefix" name="prefix" class="select2 form-control" style="width: 100%;" data-select2-id="17" tabindex="-1" aria-hidden="true" disabled>
                                        ...
                                        <div class="col-md-5" data-select2-id="56">
                                            <div class="form-group" data-select2-id="55">
                                                <label>ชื่อ</label>
                                                <input type="text" name="f_name" class="form-control" disabled placeholder="กรอกชื่อจริง" value="<?php echo $valuei['first_name'] ?>" minlength="2">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5" data-select2-id="56">
                                            <div class="form-group" data-select2-id="55">
                                                <label>นามสกุล</label>
                                                <input type="text" name="l_name" class="form-control" disabled placeholder="กรอกนามสกุล" value="<?php echo $valuei['last_name'] ?>" minlength="2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" id="m_tell" value="<?php echo $valuei['tel'] ?>" pattern="[0-9]{10}" minlength="10" maxlength="10" placeholder="กรอกเบอร์โทรศัพท์" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="pass1" id="m_pass" placeholder="กรอกรหัสผ่าน">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">ยืนยันรหัสรหัสผ่านอีกครั้ง</label>
                                    <input type="password" class="form-control" name="pass2" id="m_pass2" placeholder="กรอกรหัสผ่านอีกครั้ง">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="file" name="m_Img" class="form-control" id="m_Img" accept="image/*" disabled>
