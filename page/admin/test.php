...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var wrapper = $(".card-primary"); //Fields wrapper
            var add_form = $("#add-button"); //Add button ID
            var c = 2;
            var n = 1;
            var i =0 ;
            var x = 1; //initlal text box count
            $(add_form).click(function(e) { //on add input button click
                e.preventDefault();
                if (x < max_fields) { //max input box allowed
                    x++; //text box increment
                    $(wrapper).append(`<div class="card card-primary " id="dynamic-field">
                        <!-- <div class="dynamic-field" > -->
                        <div class="card-header" style="background:#004385; color:white;">
                        
                            <h3 class="card-title">แบบฟอร์มการปฎิบัติงาน ${c}</h3>
                                ...
                                <div>
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-2 col-form-label">ชื่อหัวข้อรายงาน :</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="head${n}[]" class="form-control" id="" placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <textarea id="summernote${i}" name=""  style="display: none;">รายละเอียดงาน</textarea>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">สถานที่ปฎิบัติงาน :</label>
                                            <div class="col-sm-4">
                                                <select class="select2" name="station${n}[]" style="width: 100%;">
                                                    <option value="สำนักงาน">สำนักงาน</option>
                                                    <option value="บ้าน">นอกสถานที่</option>
                                                </select>
                                            </div>
                                            ...
                                            <label class="col-sm-2 col-form-label">ความสำเร็จงาน :</label>
                                            <div class="col-sm-4"  style="">
                                                <select class="select2" name="succ${n}[]" style="width: 100%;">
                                                    <option value="10">10 %</option>
                                                    <option value="20">20 %</option>
                                                    <option value="30">30 %</option>
                                                    <option value="40">40 %</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="input-group col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="time${n}[]" class="form-control float-right" id="reservationtime">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cloneContainer" id="show2" style="display: none">
                                            <div class="form-group ">
                                                ...
                                                <div class="clone">
                                                    <div class="input-group ">
                                                        <input type="file" name="photo${n}[]" class="form-control ">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-sm-2 col-form-label">ปัญหาที่พบ :</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="problem${n}[]"  cols="30" rows="10" placeholder=""></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </form>
            ...
            $(wrapper).on("click", ".remove-button", function(e) { //user click on remove text
                e.preventDefault();
                $(this).$(wrapper).remove();
                x--;
            })
